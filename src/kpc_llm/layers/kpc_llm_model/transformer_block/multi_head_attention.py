...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self,input_batch):
        ...
        single_head_d = int(embed_dim / self.num_head)
        ...
        queries = queries.view(num_batch,num_token,self.num_head,single_head_d)
        keys = keys.view(num_batch,num_token,self.num_head,single_head_d)
        values = values.view(num_batch,num_token,self.num_head,single_head_d)
...
if __name__ == '__main__':
    ...
    #定义两个批次的数据
    inputs = Tensor([
        [[0.43, 0.15, 0.89,0.23, 0.85, 0.39], # Your 
        [0.55, 0.87, 0.66,0.43, 0.15, 0.89], # journey
        [0.57, 0.85, 0.64,0.43, 0.15, 0.89], # starts
        [0.22, 0.58, 0.33,0.43, 0.15, 0.89], # with 
        [0.77, 0.25, 0.10,0.43, 0.15, 0.89], # one 
        [0.05, 0.80, 0.55,0.43, 0.15, 0.89]] # step
        # ,
        #  [[0.43, 0.15, 0.89], # Your 
